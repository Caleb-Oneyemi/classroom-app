...
export default function EditCourse ({ match }) {
	...
	const clickSubmit = () => {
		...
		update({ courseId: match.params.courseId }, { t: jwt.token }, courseData).then((data) => {
			if (data && data.error) {
        ...
        <div className={classes.root}>
            <Card className={classes.card}>
                ...
                <div className={classes.flex}>
					...
					<div className={classes.details}>
						...
						<label htmlFor='icon-button-file'>
							<Button variant='outlined' color='secondary' component='span'>Change Photo
								<FileUpload/>
							</Button>
                ...
                <div>
					...
					<List>{course.lessons && course.lessons.map((lesson, index) => {
